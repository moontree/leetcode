"""
=========================
Project -> File: leetcode -> 1376_Time_Needed_to_Inform_All_Employees.py
Author: zhangchao
=========================
...
He will inform his direct subordinates and
...
class Solution(object):
    def numOfMinutes(self, n, headID, manager, informTime):
        ...
        while q:
            h, c = q.pop(0)
            for e in managers.get(h, []):
                q.append([e, c + informTime[h]])
                res = max(res, c + informTime[h])
        return res
