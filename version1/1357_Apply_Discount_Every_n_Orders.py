"""
=========================
Project -> File: leetcode -> 1357_Apply_Discount_Every_n_Orders.py
Author: zhangchao
=========================
There is a sale in a supermarket,
there will be a discount every n customer.
There are some products in the supermarket
where the id of the i-th product is products[i] and the price per unit of this product is prices[i].
...
The customer orders a certain amount of each product
where product[i] is the id of the i-th product the customer
...
returns the value of the bill and apply the discount if needed.
