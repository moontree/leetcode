...
(It follows the rules of Tic-Tac-Toe),
...
class Solution(object):
    def tictactoe(self, moves):
        ...
        def win(v):
            for i in range(3):
                if grid[i][0] == grid[i][1] == grid[i][2] == v:
                    return True
                if grid[0][i] == grid[1][i] == grid[2][i] == v:
                    return True
            if grid[0][0] == grid[1][1] == grid[2][2] == v:
                return True
            if grid[2][0] == grid[1][1] == grid[0][2] == v:
                return True
            return False
