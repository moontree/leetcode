"""
=========================
Project -> File: leetcode -> 1366_Rank_Teams_by_Votes.py
Author: zhangchao
=========================
...
Output:
    "XWYZ"
Explanation:
    X is the winner due to tie-breaking rule.
    X has same votes as W for the first position but X has one vote as second position while
